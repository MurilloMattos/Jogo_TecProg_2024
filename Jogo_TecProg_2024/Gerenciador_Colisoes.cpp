...
// Definitivamente uma melhor solu��o seria colocar essa fu��o na classe fase
...
//Verifica se a lista de inimigos do gerenciador est� vazia
//Verifica se a lista de inimigos do gerenciador est� vazia
...
//colis�o do jogador com os obst�culos
//colis�o do jogador com os obst�culos
void Gerenciador_colisoes::tratar_Colisoes_Jogador_Obstaculo(Jogador* p_Jogador) {
	...
	//verifica o tipo de colis�o especificamente com objetos.
...
//colis�o de projeteis com o jogador
//colis�o de projeteis com o jogador
...
//colis�o de qualquer coisa com os obst�culos
//colis�o de qualquer coisa com os obst�culos
...
//colis�o de projeteis com os obst�culos
//colis�o de projeteis com os obst�culos
...
//trata as colis�es entre os inimigos e os outros objetos n�o em inimigos (ainda)
//trata as colis�es entre os inimigos e os outros objetos n�o em inimigos (ainda)
...
//trata as colis�es entre o jogador e os inimigos
//trata as colis�es entre o jogador e os inimigos
...
//Essa classe tem como objetivo Garantir corretamente o lado colidido da entidade refer�ncia.
//Primeiro ela verifica as coordenadas principais, depois confirma com as secund�rias, referente a colis�o respectivamente.
const int Gerenciador_colisoes::verifica_Tipo_De_Colisao(Entidade* pEntidade_Ref, Entidade* pEntidade2) {
	...
	// verifica o maior lado em contato da entidade Refer�ncia com a colidida e retorna o lado colidido.
	if (colisao) {
...
//verifica se o objeto esta com possibilidade de colis�o.
